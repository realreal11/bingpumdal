...
const CTAButton = ({ onClick, children, variant = 'primary', className = "" }: any) => {
  ...
  const variants = {
    primary: "bg-brand-tomato text-white hover:bg-[#D32F2F] shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-[4px] active:translate-x-[4px] active:shadow-none border-2 border-black px-8 py-4 sm:px-10 sm:py-5 text-base",
    secondary: "bg-[#E1F5FE] text-[#1A1A1C] border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:bg-[#B3E5FC] hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-[4px] active:translate-x-[4px] active:shadow-none px-8 py-4 sm:px-10 sm:py-5 text-base",
    gold: "bg-[#FFF9C4] text-[#1A1A1C] hover:bg-[#FFF59D] shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] border-2 border-black hover:translate-y-[1px] hover:translate-x-[1px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-[3px] active:translate-x-[3px] active:shadow-none px-6 py-3 text-sm font-black flex items-center gap-2",
    outlineWhite: "bg-white text-[#1A1A1C] border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:translate-y-[2px] hover:translate-x-[2px] hover:shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] active:translate-y-[4px] active:translate-x-[4px] active:shadow-none px-8 py-4 sm:px-10 sm:py-5 text-base",
  };
...
export default function LandingPage() {
  ...
  return (
    <div className="font-sans bg-brand-cream text-brand-charcoal overflow-x-hidden">
      {/* Navigation */}
      ...
      <main className="pt-16">
        ...
        {/* 0. Main Cover Section */}
        <section className="relative w-full min-h-[calc(100vh-64px)] flex items-center justify-center overflow-hidden bg-[#FEFCF8]">
          {/* Subtle Photo Background */}
          <div className="absolute inset-0 z-0">
            <img src="/빙수/빙수잔뜩.jpg" alt="빙수 배경" className="w-full h-full object-cover opacity-10 mix-blend-multiply filter blur-sm" />
            <div className="absolute inset-0 bg-[#FEFCF8]/80 backdrop-blur-[2px]"></div>
          </div>

          {/* Playful Dot Grid Pattern */}
          <div className="absolute inset-0 z-0 opacity-40" style={{ backgroundImage: 'radial-gradient(#C5A059 2px, transparent 2px)', backgroundSize: '40px 40px' }}></div>
          
          {/* Animated Gradient Blobs */}
          <motion.div animate={{ scale: [1, 1.1, 1], x: [0, 30, 0], y: [0, -40, 0] }} transition={{ duration: 12, repeat: Infinity, ease: "linear" }} className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] rounded-full bg-[#E1F5FE] mix-blend-multiply filter blur-[80px] z-0 pointer-events-none" />
          <motion.div animate={{ scale: [1, 1.2, 1], x: [0, -30, 0], y: [0, 40, 0] }} transition={{ duration: 15, repeat: Infinity, ease: "linear" }} className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] rounded-full bg-[#FFEBEE] mix-blend-multiply filter blur-[80px] z-0 pointer-events-none" />
          <motion.div animate={{ scale: [1, 1.1, 1], x: [0, 40, 0], y: [0, -30, 0] }} transition={{ duration: 10, repeat: Infinity, ease: "linear" }} className="absolute top-[30%] right-[10%] w-[30vw] h-[30vw] rounded-full bg-[#FFF9C4] mix-blend-multiply filter blur-[60px] z-0 pointer-events-none" />

          {/* Floating Decorative Elements */}
          <motion.div animate={{ rotate: 360 }} transition={{ duration: 20, repeat: Infinity, ease: "linear" }} className="absolute top-[15%] left-[20%] z-10 text-brand-gold opacity-60"><Star className="w-8 h-8 pointer-events-none" fill="currentColor" /></motion.div>
          <motion.div animate={{ rotate: -360, scale: [1, 1.2, 1] }} transition={{ duration: 15, repeat: Infinity, ease: "easeInOut" }} className="absolute bottom-[20%] right-[25%] z-10 text-brand-tomato opacity-60"><Sparkles className="w-10 h-10 pointer-events-none" fill="currentColor" /></motion.div>
          <motion.div animate={{ rotate: 180, y: [0, -15, 0] }} transition={{ duration: 8, repeat: Infinity, ease: "easeInOut" }} className="absolute top-[25%] right-[15%] z-10 text-blue-400 opacity-60"><Star className="w-6 h-6 pointer-events-none" fill="currentColor" /></motion.div>

          {/* Floating Bingsu Image - Top Left */}
          <motion.img 
            src="/빙수/요거트망고빙수.png" 
            alt="요거트망고빙수"
            className="absolute top-[5%] md:top-[10%] left-[-10%] md:left-[5%] w-[180px] md:w-[300px] drop-shadow-[0_20px_40px_rgba(0,0,0,0.15)] z-20 pointer-events-none"
            animate={{ y: [-15, 15, -15], rotate: [-8, 4, -8] }}
            transition={{ repeat: Infinity, duration: 8, ease: "easeInOut" }}
          />

          {/* Floating Bingsu Image - Bottom Right */}
          <motion.img 
            src="/빙수/요거트생딸기 빙수.png" 
            alt="요거트생딸기빙수"
            className="absolute bottom-[2%] md:bottom-[5%] right-[-10%] md:right-[2%] w-[220px] md:w-[340px] drop-shadow-[0_25px_45px_rgba(0,0,0,0.2)] z-30 pointer-events-none"
            animate={{ y: [15, -15, 15], rotate: [5, -5, 5] }}
            transition={{ repeat: Infinity, duration: 7, ease: "easeInOut", delay: 1 }}
          />

          {/* Floating Bingsu Image - Top Right */}
          <motion.img 
            src="/빙수/초코빙수.png" 
            alt="초코빙수"
            className="absolute top-[12%] md:top-[8%] right-[-5%] md:right-[15%] w-[140px] md:w-[220px] drop-shadow-[0_15px_30px_rgba(0,0,0,0.12)] z-10 pointer-events-none"
            animate={{ y: [-20, 20, -20], rotate: [10, -10, 10] }}
            transition={{ repeat: Infinity, duration: 9, ease: "easeInOut", delay: 2 }}
          />

          {/* Floating Bingsu Image - Bottom Left */}
          <motion.img 
            src="/빙수/치즈빙수.png" 
            alt="치즈빙수"
            className="absolute bottom-[10%] md:bottom-[15%] left-[-5%] md:left-[10%] w-[160px] md:w-[260px] drop-shadow-[0_15px_30px_rgba(0,0,0,0.15)] z-20 pointer-events-none"
            animate={{ y: [20, -20, 20], rotate: [-5, 8, -5] }}
            transition={{ repeat: Infinity, duration: 10, ease: "easeInOut", delay: 0.5 }}
          />

          {/* Main Content */}
          <div className="relative z-40 text-center px-4 w-full flex flex-col items-center">
            <motion.div
            ...
            >
              ...
              <motion.div 
                ...
                className="inline-flex items-center gap-2 px-5 md:px-6 py-2 bg-white border-2 border-black rounded-full shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-[#1A1A1C] font-black text-sm sm:text-base mb-8 md:mb-12 rotate-[-2deg] cursor-pointer"
              >
                 <span className="text-xl">🍧</span> 세상에 없던 완벽한 조화 <span className="text-xl">🍕</span>
              </motion.div>

              <h1 className="text-5xl sm:text-7xl md:text-[96px] font-black text-[#1A1A1C] leading-[1.3] tracking-tight break-keep text-center drop-shadow-sm w-full">
                <span className="inline-block relative">
                   <span className="text-brand-tomato relative z-10">피자</span> 파는 <span className="text-blue-500 relative z-10">빙수집</span>,
                   {/* Squiggly underline behind */}
                   <svg className="absolute w-[110%] h-4 md:h-6 -bottom-1 md:-bottom-2 -left-[5%] text-[#FFEBEE] -z-10" viewBox="0 0 100 20" preserveAspectRatio="none">
                     <path d="M0,10 Q25,20 50,10 T100,10" fill="none" stroke="currentColor" strokeWidth="8"/>
                   </svg>
                </span>
                <br className="hidden sm:block"/>
                <span className="inline-block relative mt-4 sm:mt-2">
                   <span className="text-blue-500 relative z-10">빙수</span> 파는 <span className="text-brand-tomato relative z-10">피자집</span>
                   <svg className="absolute w-[110%] h-4 md:h-6 -bottom-1 md:-bottom-2 -left-[5%] text-[#E1F5FE] -z-10" viewBox="0 0 100 20" preserveAspectRatio="none">
                     <path d="M0,10 Q25,0 50,10 T100,10" fill="none" stroke="currentColor" strokeWidth="8"/>
                   </svg>
                </span>
                <br/>
                
                <div className="mt-12 md:mt-16 relative inline-block group cursor-default">
                  <span className="relative z-10 text-6xl sm:text-8xl md:text-[140px] tracking-tighter text-white drop-shadow-[0_4px_10px_rgba(0,0,0,0.3)] select-none">빙품달</span>
                  {/* Pizza Duck Character Peeking */}
                  <motion.img 
                    src="/피자덕캐릭/3d9afafce9235.png" 
                    alt="피자덕 캐릭터" 
                    className="absolute -top-16 -right-16 md:-top-24 md:-right-24 w-24 md:w-36 z-20 drop-shadow-xl"
                    animate={{ y: [0, -10, 0], rotate: [5, -5, 5] }}
                    transition={{ repeat: Infinity, duration: 4, ease: "easeInOut" }}
                  />
                  <motion.div 
                    className="absolute -inset-3 md:-inset-6 bg-brand-charcoal -z-10 rounded-2xl md:rounded-[40px] shadow-[8px_8px_0px_0px_#C5A059]"
                    initial={{ rotate: -2 }}
        ...
        <section className="relative w-full py-24 md:py-32 lg:py-40 flex items-center justify-center overflow-hidden bg-brand-cream border-b border-[#E5E0D5]" id="concept">
          ...
          {/* Floating Images (Bingsu & Pizza) */}
          <motion.div
            initial={{ opacity: 0, x: -80, y: 30, rotate: -15 }}
            animate={{ opacity: 1, x: 0, y: 0, rotate: -5 }}
            transition={{ duration: 1.2, delay: 0.2, type: "spring", bounce: 0.4 }}
            className="absolute -left-12 md:-left-4 lg:left-[5%] top-8 md:top-[15%] w-56 md:w-80 lg:w-[360px] z-20 pointer-events-none"
          >
            <motion.img
              animate={{ y: [-10, 10, -10] }}
              ...
              src="/빙수/딸샤벳빙수.png" 
              alt="딸샤벳빙수" 
              className="w-full h-auto drop-shadow-[0_20px_30px_rgba(0,0,0,0.3)] object-contain object-center"
            />
          </motion.div>
          ...
          <motion.div
            ...
            className="absolute -right-12 md:-right-4 lg:right-[5%] bottom-8 md:bottom-[10%] w-56 md:w-80 lg:w-[360px] z-20 pointer-events-none"
          >
            <motion.img 
              animate={{ y: [10, -10, 10] }}
          ...
          <div className="relative z-10 text-center px-4 md:max-w-4xl max-w-full mx-auto flex flex-col items-center">
            <motion.div
              ...
              className="bg-white/95 border-[3px] border-black p-8 md:p-14 lg:px-20 rounded-[40px] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col items-center relative overflow-hidden"
            >
              ...
              <div className="relative z-10 flex flex-col items-center">
                <div className="inline-block px-4 py-1.5 bg-[#FFF9C4] border-2 border-black text-[#1A1A1C] text-xs sm:text-sm font-black rounded-full mb-6 whitespace-nowrap shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rotate-[-1deg]">
                  빙수는 여름에, 피자는 사계절 내내!
                </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="flex flex-col lg:flex-row gap-6 mt-16">
                ...
                <div className="relative z-10 pb-8 sm:pb-0">
                  <div className="flex justify-between items-start mb-8">
                    <h3 className="text-2xl font-bold flex items-center gap-3">
                      <div className="w-12 h-12 bg-[#E1F5FE] rounded-full flex items-center justify-center text-blue-500 border-2 border-black">
                        <IceCream2 className="w-6 h-6" />
                      </div>
                      빙수의 역할
                    </h3>
                    <span className="text-blue-600 bg-white border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] px-3 py-1 text-xs font-bold rounded-full rotate-2">상시 추가 디저트 & 홀 견인!</span>
                  </div>
              ...
              <div className="hidden lg:flex items-center justify-center">
                <div className="w-12 h-12 bg-[#FFF9C4] rounded-full border-[3px] border-black flex items-center justify-center z-10 -mx-6 text-[#1A1A1C] font-black text-xl shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transform hover:scale-110 transition-transform">
                  +
                </div>
              </div>

              <FadeIn delay={0.2} className="flex-1 bg-white rounded-3xl p-8 lg:p-12 border-[3px] border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] relative overflow-hidden group hover:-translate-y-2 transition-transform">
                ...
                <div className="relative z-10 pb-8 sm:pb-0">
                  <div className="flex justify-between items-start mb-8">
                    <h3 className="text-2xl font-bold flex items-center gap-3">
                      <div className="w-12 h-12 bg-[#FFEBEE] rounded-full flex items-center justify-center text-brand-tomato border-2 border-black">
                        <Pizza className="w-6 h-6" />
                      </div>
                      피자의 역할
                    </h3>
                    <span className="text-brand-tomato bg-white border-2 border-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] px-3 py-1 text-xs font-bold rounded-full -rotate-2">든든한 메인 배달 강자!</span>
                  </div>
                  <ul className="space-y-4">
                    {[
        ...
        <section className="py-24 px-4 bg-[#FACC15] relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10 flex flex-col items-center">
             ...
             <div className="text-center w-full px-4 text-[#E53935]">
               ...
               <button onClick={scrollToForm} className="bg-white text-[#1A1A1C] font-black text-xl sm:text-2xl md:text-3xl px-12 sm:px-20 py-6 border-[3px] md:border-[4px] border-[#1A1A1C] rounded-[40px] shadow-[6px_6px_0_0_rgba(26,26,28,1)] hover:translate-x-1 hover:translate-y-1 hover:shadow-[3px_3px_0_0_rgba(26,26,28,1)] transition-all">
                 상담신청하기
               </button>
             </div>
          </div>
        ...
        <section className="py-24 px-4 bg-brand-charcoal text-white">
          ...
          <FadeIn delay={0.4} className="max-w-4xl mx-auto mt-20 text-center border-t border-brand-charcoal/10 pt-16">
             <h4 className="text-2xl font-bold text-brand-charcoal mb-4">"두 가지 메뉴, 운영이 너무 복잡하지 않을까요?"</h4>
             <p className="text-gray-500 mb-8 max-w-xl mx-auto">본사의 체계적인 원팩 시스템과 효율화된 조리 동선을 통해 점주님의 초기 운영 부담을 적극적으로 낮춰 드립니다.</p>
             <button onClick={scrollToForm} className="inline-flex items-center justify-center gap-2 bg-brand-charcoal hover:bg-black text-white px-8 py-4 rounded-xl font-bold transition shadow-lg w-full sm:w-auto">
               본사 시스템 안내 상담하기 <ArrowRight className="w-5 h-5" />
             </button>
          </FadeIn>
        </section>
        ...
        <section className="py-24 px-4 bg-[#FEFCF8] relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-6 lg:gap-10 mt-12">
               {/* Delivery Card */}
               <FadeIn delay={0.1} className="p-8 md:p-10 rounded-[32px] border-[3px] border-black bg-white shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col h-full transform transition-transform hover:-translate-y-2">
                 <div className="w-20 h-20 rounded-2xl flex items-center justify-center mb-8 bg-[#FFF9C4] border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-[#1A1A1C] rotate-[-3deg]">
                   <span className="text-4xl">🛵</span>
                 </div>
                 <h3 className="text-3xl font-black mb-4 text-[#1A1A1C]">강력한 배달 수익</h3>
                 <div className="inline-block px-4 py-2 bg-[#FFEBEE] border-2 border-black rounded-lg text-brand-tomato font-bold text-sm mb-4 self-start shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rotate-1">
                   "객단가를 확 높이는 마법의 세트"
                 </div>
                 <p className="text-base md:text-lg leading-relaxed text-gray-700 font-medium">
                   식사 주문 시 디저트까지 원스톱으로! 배달비에 민감한 요즘, 식사와 디저트를 한 매장에서 배달시킬 수 있어 고객은 배달비를 절약하고 점주님은 <span className="font-bold text-brand-tomato">압도적으로 높은 객단가</span>를 달성합니다.
                 </p>
               </FadeIn>
               
               {/* Dine-in Card */}
               <FadeIn delay={0.2} className="p-8 md:p-10 rounded-[32px] border-[3px] border-black bg-[#E1F5FE] shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col h-full transform transition-transform hover:-translate-y-2 lg:translate-y-6">
                 <div className="w-20 h-20 rounded-2xl flex items-center justify-center mb-8 bg-[#E5F6DF] border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] text-[#1A1A1C] rotate-[3deg]">
                   <span className="text-4xl">🍕</span>
                 </div>
                 <h3 className="text-3xl font-black mb-4 text-[#1A1A1C]">탄탄한 홀 매출</h3>
                 <div className="inline-block px-4 py-2 bg-white border-2 border-black rounded-lg text-blue-600 font-bold text-sm mb-4 self-start shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] -rotate-1">
                   "입과 눈이 즐거운 테이블 시너지"
                 </div>
                 <p className="text-base md:text-lg leading-relaxed text-gray-700 font-medium">
            ...
            <div className="mt-20 text-center bg-[#FFF9C4] border-[3px] border-black p-6 md:p-8 rounded-3xl shadow-[6px_6px_0px_0px_rgba(0,0,0,1)] max-w-4xl mx-auto flex flex-col sm:flex-row items-center justify-center gap-6 transform rotate-1 hover:rotate-0 transition-transform cursor-default">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="mb-16">
              <h3 className="text-2xl font-black mb-8 pl-4 border-l-4 border-blue-500 flex items-center gap-2">
                수제 빙수 & 디저트 
                <span className="text-xs font-bold text-blue-600 bg-white border-2 border-black px-2 py-1 rounded-full uppercase tracking-widest ml-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] rotate-1">
                  객단가 치트키
                </span>
              </h3>
            ...
            <div>
              <h3 className="text-2xl font-black mb-8 pl-4 border-l-4 border-brand-tomato flex items-center gap-2">
                프리미엄 피자 
                <span className="text-xs font-bold text-brand-tomato bg-white border-2 border-black px-2 py-1 rounded-full uppercase tracking-widest ml-2 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] -rotate-1">
                  호불호 제로 메인
                </span>
              </h3>
              <div className="flex overflow-x-auto sm:grid sm:grid-cols-2 md:grid-cols-4 gap-4 pb-6 sm:pb-0 snap-x -mx-4 px-4 sm:mx-0 sm:px-0 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
              {[
                ...
                <FadeIn key={i} delay={i * 0.1} className="bg-white p-8 rounded-2xl shadow-sm border border-[#E5E0D5] relative overflow-hidden group">
                  <div className="absolute top-0 right-0 p-6 text-6xl font-black text-[#F9F7F2] opacity-80 group-hover:scale-110 transition-transform">{item.num}</div>
                  <div className="relative z-10">
                    <div className="w-12 h-12 bg-[#F9F7F2] border border-[#E5E0D5] text-brand-charcoal rounded-xl flex items-center justify-center mb-6">
                      {React.cloneElement(item.icon as React.ReactElement, { className: "w-5 h-5 text-gray-700" })}
                    </div>
                    <h4 className="text-lg font-bold mb-3 text-brand-charcoal flex items-center gap-2">{item.title}</h4>
        ...
        <section className="py-24 px-4 bg-white text-center border-b border-[#E5E0D5] relative">
           <div className="max-w-3xl mx-auto">
             <div className="w-full h-48 sm:h-72 lg:h-96 rounded-3xl overflow-hidden mb-12 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] border-[3px] border-black rotate-1 hover:rotate-0 transition-transform">
                <img src="/각종사진/가게사진.png" alt="빙품달 매장 전경" className="w-full h-full object-cover" />
             </div>
             <div className="w-20 h-20 bg-[#F9F7F2] border-[3px] border-black rounded-full flex items-center justify-center mx-auto mb-8 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]">
               <ShieldCheck className="w-8 h-8 text-[#1A1A1C]" />
             </div>
