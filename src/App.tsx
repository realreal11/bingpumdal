...
export default function LandingPage() {
  ...
  const [showSalesPopup, setShowSalesPopup] = useState(() => {
    if (typeof window !== 'undefined') {
      return !localStorage.getItem('hasSeenSalesPopup_v2');
    }
    return true;
  });

  const handleCloseSalesPopup = (neverShowAgain = false) => {
    if (neverShowAgain) {
      localStorage.setItem('hasSeenSalesPopup_v2', 'true');
    }
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <div className="fixed top-16 inset-x-0 z-[49] bg-[#D32F2F] text-white text-[13px] sm:text-sm font-bold py-2.5 px-4 text-center flex items-center justify-center gap-2 shadow-md">
