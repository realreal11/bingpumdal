...
const salesDataRow1 = [
  ...
  { name: "인천남동점", date: "2025년 7월", amount: "71,396,000" },
];

const salesDataRow2 = [
  { name: "대전유성점", date: "2025년 8월", amount: "89,450,000" },
  { name: "수원장안점", date: "2025년 7월", amount: "112,040,500" },
  { name: "광주상무점", date: "2025년 8월", amount: "95,300,000" },
  { name: "천안서북점", date: "2025년 7월", amount: "78,920,000" },
  { name: "제주연동점", date: "2025년 8월", amount: "64,500,000" },
  { name: "울산남구점", date: "2025년 7월", amount: "82,100,000" },
];
...
const SalesMarqueeSection = () => {
  return (
    <section className="relative pt-16 pb-8 bg-[#18181A] overflow-hidden border-t-[10px] border-black border-b-[8px] border-[#3E3E3E] shadow-[0_0_50px_rgba(0,0,0,0.8)_inset]">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 mb-8 text-center flex flex-col items-center">
        <div className="flex items-center justify-center gap-2 sm:gap-6">
           <LaurelIcon />
           <div className="flex flex-col items-center pt-4">
             <h3 className="text-white text-lg sm:text-2xl font-bold mb-1 tracking-tight drop-shadow-md">배달형 매장 <span className="font-black">월매출 1억!</span></h3>
             <h2 className="text-[#F44336] text-[40px] sm:text-6xl md:text-[80px] font-black tracking-tighter drop-shadow-lg leading-none">100,000,000<span className="text-2xl sm:text-4xl md:text-[50px] font-bold ml-1 text-[#E53935]">원</span></h2>
           </div>
           <LaurelIcon flip />
        </div>
      </div>
      ...
      <div className="relative z-10 mt-6 text-center text-gray-400 font-bold text-[10px] sm:text-xs">
      ...
      <main className="pt-16">
        ...
        <section className="relative w-full min-h-screen py-32 flex flex-col justify-center overflow-hidden bg-[#111111]">
          ...
          <div className="relative z-30 text-center w-full max-w-6xl mx-auto px-4 mt-8 lg:mt-0">
             {/* Logo Container */}
             <div className="flex justify-center items-center gap-6 sm:gap-10 mb-8 lg:mb-12">
               <motion.img 
                 ...
                 src="/로고/빙품달로고.png" 
                 alt="빙수품은달 로고" 
                 className="h-12 sm:h-16 md:h-20 lg:h-24 object-contain drop-shadow-2xl" 
               />
               <motion.div 
             ...
             <h2 className="text-white text-lg md:text-3xl lg:text-4xl font-bold mb-6 lg:mb-8 drop-shadow-md break-keep">
               <span className="bg-[#D32F2F] px-2 py-1 tracking-tight mr-1">빙수X피자</span> 완벽한 듀얼 매출 시스템
             </h2>
             <h1 className="text-white text-4xl sm:text-5xl md:text-[72px] lg:text-[88px] xl:text-[100px] font-black mb-6 lg:mb-10 tracking-tighter leading-[1.2] drop-shadow-lg break-keep">
               인생이 걸린 창업,<br/> 리스크를 최대한 줄여드립니다.
             </h1>
             <p className="text-white text-lg sm:text-xl md:text-3xl lg:text-4xl font-bold mb-4 drop-shadow-md break-keep">
               전문성과 안정성을 동시에 잡은 듀얼 코어 창업
             </p>
             <p className="text-[#F1C40F] text-2xl sm:text-3xl md:text-5xl lg:text-6xl font-black mb-10 lg:mb-16 drop-shadow-lg break-keep tracking-tight">
               총 2400만원 상당의 혜택 지원
             </p>
             
             {/* Center Image */}
             <div className="relative w-full max-w-2xl mx-auto h-[140px] sm:h-[300px] md:h-[400px] mb-8 sm:mb-12 flex items-center justify-center">
                <motion.img 
                  animate={{ y: [-10, 10, -10], rotate: [-2, 2, -2] }}
                  transition={{ repeat: Infinity, duration: 6, ease: "easeInOut" }}
                  src="/빙수/치즈빙수.png" 
                  alt="치즈빙수" 
                  className="absolute left-[15%] sm:left-[0%] md:left-[2%] w-28 sm:w-64 md:w-80 drop-shadow-[0_20px_40px_rgba(0,0,0,0.6)] z-20 hover:scale-105 transition-transform" 
                />
                <motion.img 
                  animate={{ y: [10, -10, 10], rotate: [2, -2, 2] }}
                  ...
                  src="/피자/포덕포덕피자.png" 
                  alt="포덕포덕피자" 
                  className="absolute right-[15%] sm:right-[0%] md:right-[2%] w-28 sm:w-64 md:w-80 drop-shadow-[0_20px_40px_rgba(0,0,0,0.6)] z-10 hover:scale-105 transition-transform" 
                />
             </div>
